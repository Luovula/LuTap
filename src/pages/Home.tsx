...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    // Create a reference to the specific document in the "News" collection
    const docRef = doc(db, "News", "Current"); // Replace YOUR_DOCUMENT_ID with the actual ID
    ...
    const fetchDoc = async () => {
      ...
      if (docSnap.exists()) {
        // Extract the data if the document exists
